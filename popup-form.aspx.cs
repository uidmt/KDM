    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            using (MailMessage mail = new MailMessage())
            {
                ...
                //mail.To.Add(new MailAddress("reenasinghseo@gmail.com"));
                //mail.CC.Add(new MailAddress("info@kingofdigitalmarketing.com"));
                //mail.Bcc.Add(new MailAddress("b2kingofdigitalmarketing@gmail.com"));
                ...
                {
                    smtp.Credentials = new NetworkCredential("info.kingofdigital@gmail.com", "baba@9442780258@");
