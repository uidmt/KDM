...
;(function($, window, document, undefined) {
	 ...
	 * @public
	 * @param {HTMLElement|jQuery} element - The element to create the images for.
	...
	function Owl(element, options) {
		...
		/**
		 * Current settings for the images.
		 * @protected
		 */
		this.settings = null;
		...
		/**
		 * References to the running plugins of this images.
		 * @protected
		 */
		this.plugins = {};
	...
	/**
	 * Default options for the images.
	 * @public
	 */
	Owl.Defaults = {
		items: 3,
	...
	/**
	 * Refreshes the images primarily for adaptive purposes.
	 * @public
	 */
	...
	Owl.prototype.addItem = function(content, position) {
		...
		// if images is empty then append item
	...
	Owl.prototype.addTriggerableEvents = function() {
		...
		$.each({
			...
			this.dom.$el.on(event + '.owl.images', handler(callback, event + '.owl.images'));
		}, this));

	};

	/**
	 * Watches the visibility of the images element.
	 * @protected
	 */
	...
	Owl.prototype.destroy = function() {
		...
		// Remove event handlers in the ".owl.images" namespace
		this.dom.$el.off('.owl');
	 ...
	 * @param {String} [namespace=.owl.images] - The event namespace.
	...
	Owl.prototype.trigger = function(name, data, namespace) {
		var status = {
			...
			[ name, 'owl', namespace || 'images' ].join('.').toLowerCase(),
...
;(function($, window, document, undefined) {
	...
	LazyLoad = function(scope) {
		...
		this.handlers = {
			'changed.owl.images': $.proxy(function(e) {
...
;(function($, window, document, undefined) {
	...
	Video = function(scope) {
		...
		this.handlers = {
			'resize.owl.images': $.proxy(function(e) {
				if (this.owl.settings.video && !this.isInFullScreen()) {
					e.preventDefault();
				}
			}, this),
			'refresh.owl.images changed.owl.images': $.proxy(function(e) {
				if (this.owl.state.videoPlay) {
					this.stopVideo();
				}
			}, this),
			'refresh.owl.images refreshed.owl.images': $.proxy(function(e) {
...
;(function($, window, document, undefined) {
	...
	Animate = function(scope) {
		...
		this.handlers = {
			'change.owl.images': $.proxy(function(e) {
				if (e.property.name == 'position') {
					this.previous = this.core.current();
					this.next = e.property.value;
				}
			}, this),
			'drag.owl.images dragged.owl.images translated.owl.images': $.proxy(function(e) {
				this.swapping = e.type == 'translated';
			}, this),
			'translate.owl.images': $.proxy(function(e) {
...
;(function($, window, document, undefined) {
	...
	Autoplay = function(scope) {
		...
		this.handlers = {
			'translated.owl.images refreshed.owl.images': $.proxy(function() {
				this.autoplay();
			}, this),
...
;(function($, window, document, undefined) {
	 ...
	 * @class The Navigation Plugin
	 * @param {Owl} images - The Owl Carousel.
	 */
	var Navigation = function(images) {
		/**
		...
		/**
		 * Overridden methods of the images.
		 * @type {Object}
		 */
		this.overrides = {
			next: this.core.next,
		...
		this.handlers = {
			...
			'refreshed.owl.images': $.proxy(function() {
				if (this.initialized) {
					this.update();
					this.draw();
				}
	...
	/**
	 * Initializes the layout of the plugin and extends the images.
	 * @protected
	 */
	Navigation.prototype.initialize = function() {
		...
		// override public methods of the images
	...
	/**
	 * Gets the current page position of the images.
	 * @protected
	 * @returns {Number}
	 */
...
;(function($, window, document, undefined) {
	...
	var Hash = function(images) {
		 ...
		 */
		this.handlers = {
			'initialized.owl.images': $.proxy(function() {
