            ...
            <div class="container" style="position: relative; z-index: 2;">
                <div class="row custom-row align-items-center">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="kdm-left-stats-grid">
                            <div class="kdm-left-stat-card">
                                <div class="kdm-left-stat-icon"><i class="fa fa-globe"></i></div>
                            ...
                            <div class="kdm-left-stat-card">
                                <div class="kdm-left-stat-icon"><i class="fa fa-check-circle"></i></div>
                                <div class="kdm-left-stat-info">
                                    <strong>850+ Projects</strong>
                                    <span>High ROI Delivered</span>
                                </div>
                            </div>
                            <div class="kdm-left-stat-card">
                                <div class="kdm-left-stat-icon"><i class="fa fa-user-md"></i></div>
                                <div class="kdm-left-stat-info">
                                    <strong>10+ Yrs Experts</strong>
                                    <span>Dedicated Strategists</span>
                                </div>
                            </div>
                            <div class="kdm-left-stat-card">
                                <div class="kdm-left-stat-icon"><i class="fa fa-clock-o"></i></div>
                                <div class="kdm-left-stat-info">
                                    <strong>24/7 Execution</strong>
                                    <span>SEO, SMO &amp; PPC Ads</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 24px;">
                            <a href="tel:+919821918208" target="_blank" class="kdm-btn-primary-glow">
                                <i class="fa fa-phone"></i> Let's Talk About Your Business
                            </a>
                            <a href="/About-Us.aspx" target="_blank" class="kdm-btn-glass">
                                Know More About Us <i class="fa fa-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="kdm-founder-card">
                            <div>
                                <div class="kdm-founder-img-wrapper">
                                    ...
                                    <div class="kdm-verified-badge" title="Verified Founder & CEO"><i class="fa fa-check"></i></div>
                                </div>
                                <h3 class="kdm-founder-name">Gaurav Dubey</h3>
                                <div class="kdm-founder-title">Founder &amp; CEO</div>
                                <p style="color: #cbd5e1; font-size: 13px; margin-bottom: 14px; line-height: 1.5;">
                                    Senior Digital Marketing Consultant &amp; Performance Trainer
                                </p>
                            </div>
                            ...
                            <a href="gaurav-dubey.aspx" target="_blank" class="kdm-founder-profile-link">
                                <i class="fa fa-user-circle"></i> View Gaurav Dubey's Full Profile
                            </a>
                        </div>
                    </div>
