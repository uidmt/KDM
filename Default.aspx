        ...
        <script type="application/ld+json">
{
  ...
  "aggregateRating": {
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <!-- ===== NUMBERS DO SPEAK A LOT SECTION (WHITE THEME) ===== -->
        <section class="kdm-numbers-white-section">
            <div class="container">
                <div class="kdm-numbers-header">
                    <div class="kdm-numbers-badge">
                        <i class="fa fa-bar-chart fa-solid fa-chart-simple"></i> PROVEN MILESTONES &amp; IMPACT
                    </div>
                    <h2 class="kdm-numbers-title">NUMBERS DO <span class="kdm-blue-gradient">SPEAK A LOT !</span></h2>
                    <p class="kdm-numbers-subtitle">
                ...
                <div class="row custom-row">
                    <div class="col-md-6 col-sm-12">
                        <a href="https://www.kingofdigitalmarketing.com/industries-we-serve.aspx" class="kdm-number-card-link">
                            <div class="kdm-number-card">
                                <div class="kdm-number-icon-box">
                                    <img src="images/icons8-experience-80.png" alt="Experience Icon">
                                </div>
                                <div class="kdm-number-info">
                                    <h4>Experience of Working on Different Projects</h4>
                                    <p class="kdm-number-val">250+ Industries</p>
                                    <h5 class="kdm-number-sub">For More Than 12 Countries</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="https://www.kingofdigitalmarketing.com/Our-Portfolio.aspx" class="kdm-number-card-link">
                            <div class="kdm-number-card">
                                <div class="kdm-number-icon-box">
                                    <img src="images/icons8-success-80.png" alt="Success Icon">
                                </div>
                                <div class="kdm-number-info">
                                    <h4>Few Brands We've Worked With</h4>
                                    <p class="kdm-number-val">150+ Success Stories</p>
                                    <h5 class="kdm-number-sub">Of Most Influential Brands</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="https://www.kingofdigitalmarketing.com/seo-case-study.aspx" class="kdm-number-card-link">
                            <div class="kdm-number-card">
                                <div class="kdm-number-icon-box">
                                    <img src="images/icons8-view-80.png" alt="Growth Icon">
                                </div>
                                <div class="kdm-number-info">
                                    <h4>Growth We've Driven In Numbers</h4>
                                    <p class="kdm-number-val">400+ Case Studies</p>
                                    <h5 class="kdm-number-sub">Created Consistent Growth on Multi-channel</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="#" class="kdm-number-card-link">
                            <div class="kdm-number-card">
                                <div class="kdm-number-icon-box">
                                    <img src="images/icons8-review-80.png" alt="Review Icon">
                                </div>
                                <div class="kdm-number-info">
                                    <h4>We're a 4.9 Rated Agency</h4>
                                    <p class="kdm-number-val">410+ Reviews</p>
                                    <h5 class="kdm-number-sub">On Google, Facebook &amp; Others</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="https://www.kingofdigitalmarketing.com/team.aspx" class="kdm-number-card-link">
                            <div class="kdm-number-card">
                                <div class="kdm-number-icon-box">
                                    <img src="images/icons8-team-80.png" alt="Team Icon">
                                </div>
                                <div class="kdm-number-info">
                                    <h4>Discovery, Planning &amp; Execution</h4>
                                    <p class="kdm-number-val">12+ Years Experience</p>
                                    <h5 class="kdm-number-sub">Team for Your Success</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="https://www.kingofdigitalmarketing.com/digital-marketing-course.aspx" class="kdm-number-card-link">
                            <div class="kdm-number-card">
                                <div class="kdm-number-icon-box">
                                    <img src="images/icons8-student-80.png" alt="Projects Icon">
                                </div>
                                <div class="kdm-number-info">
                                    <h4>Experience That Speaks</h4>
                                    <p class="kdm-number-val">850+ Projects Done</p>
                                    <h5 class="kdm-number-sub">Delivering Excellence Across Worldwide</h5>
                                </div>
                            </div>
                        </a>
                    </div>
