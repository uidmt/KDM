        ...
        <section class="kdm-numbers-dark-section">
            <div class="container">
                <div class="kdm-numbers-header-dark">
                    ...
                    <h2 class="kdm-numbers-title-dark">NUMBERS DO <span class="kdm-theme-gradient">SPEAK A LOT !</span></h2>
                    <p class="kdm-numbers-subtitle-dark">
                        King of Digital Marketing is one of India's best digital marketing services company. Having 13+ years of experience proves that we have a professional and result oriented digital marketing team who has nailed the power of consulting, discovering, planning, executing and reporting. With the experience of working for over 900+ companies worldwide, we have achieved the confidence to take care of digital marketing strategies for your company. We have worked with more than 400 case of success with our determination to provide the best. Some of those companies are VLCC, Meena Bazaar, ISKCON, SkinLab by Dr. Jamuna Pai, QHT, SkinMumma, Dr. A's Clinic, Planet Education, Aliff, Global Opportunies and the list is everlasting. With more than 400 case studies we have created consistent growth on multi channel digital platforms. Last but not least, gaining the trust and reviews of 410+ individuals with 4.9 ratings on Google, Facebook, Glassdoor &amp; JustDial, we have the confidence to say that King of Digital Marketing has the whole package for your growing company to ace the Digital Market with excellence.
                    </p>
                </div>
                ...
                <div class="row custom-row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="https://www.kingofdigitalmarketing.com/industries-we-serve.aspx" class="kdm-number-card-dark-link">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="https://www.kingofdigitalmarketing.com/Our-Portfolio.aspx" class="kdm-number-card-dark-link">
                            <div class="kdm-number-card-dark">
                                <div class="kdm-number-svg-box">
                                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="https://www.kingofdigitalmarketing.com/seo-case-study.aspx" class="kdm-number-card-dark-link">
                            <div class="kdm-number-card-dark">
                                <div class="kdm-number-svg-box">
                                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="https://www.kingofdigitalmarketing.com/digital-marketing-course.aspx" class="kdm-number-card-dark-link">
                            <div class="kdm-number-card-dark">
                                <div class="kdm-number-svg-box">
                                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="container">
                ...
                <div class="kdm-credentials-5grid counters dark counters-row">
                    ...
                    <div class="kdm-credentials-box">
                        ...
                        <strong class="counter-value kdm-cred-num" data-to="4.9">4.9★</strong>
