<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popup-form.aspx.cs" Inherits="contact" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quick Enquiry - King of Digital Marketing</title>
    <!-- FontAwesome Icons -->
    ...
    <form id="form1" runat="server">
        ...
        <div class="popup-form-grid">
            ...
            <div class="popup-field">
                ...
                <asp:TextBox ID="TextBox4" runat="server" CssClass="popup-input" placeholder="City / Location"></asp:TextBox>
            </div>

            <!-- Submit -->
            <div class="popup-field">
                <asp:Button ID="Button1" runat="server" CssClass="popup-btn-submit" onclick="Button1_Click" Text="REQUEST FREE CALL BACK &rarr;" />
            </div>
        </div>
    </form>
