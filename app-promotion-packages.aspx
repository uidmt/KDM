        ...
        <section class="kdm-pkg-hero">
            <div class="kdm-pkg-hero-content">
                ...
                <div class="kdm-pkg-cta-group">
                    ...
                    <a href="javascript:void(0);" onclick="openPackageModal('App Promotion Consultation')" class="kdm-btn-hero-whatsapp"><i class="fa fa-calendar"></i> Request Free App Audit</a>
                </div>
            </div>
        </section>
              ...
              <div class="kdm-faq-accordion">
                <div class="kdm-faq-item active">
                    ...
                    <div class="kdm-faq-body">
                        <p class="kdm-faq-answer"><span class="kdm-ans-badge">Ans</span> Our App Promotion Packages include app install ads on Meta & Google, ASO, creative making, tracking setup, and continuous campaign optimization.</p>
                    </div>
                </div>
                <div class="kdm-faq-item">
                    ...
                    <div class="kdm-faq-body">
                        <p class="kdm-faq-answer"><span class="kdm-ans-badge">Ans</span> We promote apps on Google App Campaigns, Meta Ads (Facebook/Instagram), Apple Search Ads, and major ad networks.</p>
                    </div>
                </div>
                <div class="kdm-faq-item">
                    <button type="button" class="kdm-faq-header">
                    ...
                    <div class="kdm-faq-body">
                        <p class="kdm-faq-answer"><span class="kdm-ans-badge">Ans</span> Yes. We focus on targeted genuine users who install and engage with your app.</p>
                    </div>
                </div>
                <div class="kdm-faq-item">
                    <button type="button" class="kdm-faq-header">
                    ...
                    <div class="kdm-faq-body">
                        <p class="kdm-faq-answer"><span class="kdm-ans-badge">Ans</span> Yes. We promote Android apps on Google Play Store and iOS apps on Apple App Store.</p>
                    </div>
                </div>
                <div class="kdm-faq-item">
                    <button type="button" class="kdm-faq-header">
                    ...
                    <div class="kdm-faq-body">
                        <p class="kdm-faq-answer"><span class="kdm-ans-badge">Ans</span> We use Firebase, GA4, AppsFlyer/Adjust SDKs, and in-app event tracking for 100% accurate attribution.</p>
                    </div>
                </div>
                <div class="kdm-faq-item">
                    <button type="button" class="kdm-faq-header">
                    ...
                    <div class="kdm-faq-body">
                        <p class="kdm-faq-answer"><span class="kdm-ans-badge">Ans</span> Initial install velocity is visible within the first 7-14 days of campaign launch.</p>
                    </div>
                </div>
              </div>
            </div>
